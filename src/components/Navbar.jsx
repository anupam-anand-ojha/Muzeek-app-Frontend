...
function Navbar() {
  ...
  <div className="drawer-content">
    {/* Navbar */}
    <nav className="navbar w-full fixed top-0 z-50 px-3  backdrop-blur-xl bg-black/30 bg-white/ border-b border-white/20 text-brown shadow-lg " >
      <label htmlFor="my-drawer-4" aria-label="open sidebar" className="btn btn-square btn-ghost">
        {/* Sidebar toggle icon */}
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" strokeLinejoin="round" strokeLinecap="round" strokeWidth="2" fill="none" stroke="currentColor" className="my-1.5 inline-block size-4"><path d="M4 4m0 2a2 2 0 0 1 2 -2h12a2 2 0 0 1 2 2v12a2 2 0 0 1 -2 2h-12a2 2 0 0 1 -2 -2z"></path><path d="M9 4v16"></path><path d="M14 10l2 2l-2 2"></path></svg>
      </label>
      <div className=" text-center text-white text-xl font-black lg:px-3 lg:font-black lg:text-xl"> MUZEEK ♪</div>
      {/* Right side */}
  <div className="hidden lg:flex navbar-end ml-auto gap-3 items-center">
...
<div className='navbar-end lg:hidden ml-auto'>
  ...
  <div className="drawer-side fixed backdrop-blur-xl bg-black/30 bg-white/5 border-b border-white/20 text-white shadow-lg">
    <label htmlFor="my-drawer-4" aria-label="close sidebar" className="drawer-overlay"></label>
    <div className="flex min-h-full flex-col items-start bg-base-300 is-drawer-open:w-20 is-drawer-open:w-64 backdrop-blur-xl bg-black/30 bg-white/5 border-b border-white/20 text-white shadow-lg">
      {/* Sidebar content here */}
      <ul className="menu w-full grow pt-20 backdrop-blur-xl bg-black/40 border-b border-white/10 text-white shadow-lg">
        {/* List item */}
        <li>
